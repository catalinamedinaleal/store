...
import { STORE_CFG } from './config.js';
...
const CFG = STORE_CFG || window.STORE_CFG || {};
...
export const StoreAPI = {
  ...
  schemaCheck(opts) {
    return apiPost({ action: 'schema.check' }, opts);
  },
  ...
  updateInventoryMeta(data, opts) {
    return apiPost({
      action: 'inventory.updateMeta',
      ...(isObj(data) ? data : {})
    }, opts);
  },
